...
### Возможности:
  ...
  - Пересылка изображений/аудио/видео/документов/голосовых сообщений (Только из ВК в Telegram!)
...
### Планы на будущее
 - Доработать отправку картинок ( Если отправлено несколько фоточек в ВК, то в телегу придёт только первая)
 - Настроить передачу картинок/видео/файлов/документов из Telegram в ВК
 - Улучшить отображение пересланных сообщений ( сейчас это еле работает, спасибо хоть на этом)
 ...
 - Сделать реагирование на различные события (Ex. при смене аватарки чата в ВК, бот менял аватарку в чате в Telegram на такую же )
